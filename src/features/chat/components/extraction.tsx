...
export const Extraction = ({ data }: ExtractionProps) => {
  ...
  if (!success || !searchData) {
    return (
      <Card className="mx-auto w-full max-w-md bg-gray-900 text-gray-100 shadow-lg">
  ...
  return (
    <Card className="mx-auto w-full max-w-md border-gray-800 bg-gray-900 text-gray-100 shadow-lg">
          ...
          <div className="flex items-start justify-between">
            <div>
              <div className="text-2xl font-bold">
                {answerBox.answer ||
                  answerBox.stockPrice ||
                  formatValue(Object.values(answerBox)[0])}
              </div>
              <div className="text-sm text-gray-400">
                {answerBox.description ||
                  formatValue(Object.entries(answerBox)[1]?.[1])}
              </div>
            </div>
            ...
            {Object.entries(mainData)
              ...
              .map(([key, value]) => {
                ...
                return (
                  <div
                    key={key}
                    className="flex justify-between border-t border-gray-800 py-2"
                  >
            ...
            if (isObject(value) && key !== "answerBox") {
              return (
                <div key={key} className="mt-4">
                  ...
                  <div className="mt-2 space-y-2 border-l border-gray-800 pl-2">
