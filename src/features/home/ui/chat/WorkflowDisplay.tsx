...
export function WorkflowDisplay({
  ...
  const stepperSteps: StepperStep[] = [
    {
      key: WorkflowStep.SchemaGeneration,
      label: "Schema Generation",
      description: "Creating data structure",
    },
    {
      key: WorkflowStep.Search,
      label: "Search",
      description: "Finding data sources",
    },
    {
      key: WorkflowStep.Extraction,
      label: "Data Extraction",
      description: "Processing data",
    },
    {
      key: WorkflowStep.Deployment,
  ...
  return (
    <div className="z-10 mx-auto flex min-h-full w-full flex-col p-6 py-16">
      ...
      <div className="">
        ...
        {currentStep === WorkflowStep.SchemaGeneration &&
          generateSchemaMutation.isPending && (
            <div className="flex flex-col items-center justify-center space-y-4 p-12">
              ...
              <p className="text-sm text-gray-400">
                Analyzing your request and creating a data structure
              </p>
            </div>
          )}
        ...
        {currentStep === WorkflowStep.Search && searchMutation.isPending && (
          <div className="flex flex-col items-center justify-center space-y-4 p-12">
            ...
            <p className="text-sm text-gray-400">
              Finding the best sources to power your API
            </p>
          </div>
        )}

        {currentStep === WorkflowStep.Search &&
          searchResults &&
          !searchMutation.isPending && <SearchResults data={searchResults} />}
        ...
        {currentStep === WorkflowStep.Extraction &&
          extractMutation.isPending && (
            <div className="flex flex-col items-center justify-center space-y-4 p-12">
              ...
              <p className="text-sm text-gray-400">
                Transforming web data into structured API responses
              </p>
            </div>
          )}
        ...
        {currentStep === WorkflowStep.Extraction &&
          extractedData &&
          !extractMutation.isPending && <Extraction data={extractedData} />}

        {/* Stage 4: Deployment */}
        {currentStep === WorkflowStep.Deployment &&
          deployMutation.isPending && (
            <div className="flex flex-col items-center justify-center space-y-4 p-12">
              <div className="h-12 w-12 animate-spin rounded-full border-4 border-blue-500 border-t-transparent"></div>
              <p className="text-lg">Deploying your API...</p>
              <p className="text-sm text-gray-400">
                Setting up endpoints and documentation
              </p>
            </div>
          )}
        ...
        {currentStep === WorkflowStep.Deployment &&
          ...
          deploymentData && (
            <div className="flex flex-col items-center justify-center space-y-4 p-12">
              ...
              <p className="text-lg">
                Setting up your API endpoints and documentation...
              </p>
        ...
        {currentStep !== WorkflowStep.Idle && (
          <div className="flex flex-col items-center space-y-2 pb-8 pt-6">
            <button
              onClick={resetWorkflow}
              className="flex justify-center rounded-md bg-gray-700 px-4 py-2 text-white hover:bg-gray-600"
            >
              Start Over
            </button>
