...
const ReviewCard = ({
    ...
    return (
        <figure
            className={cn(
                "relative h-full w-72 cursor-pointer overflow-hidden rounded-xl border p-4 mx-2 transition-all duration-300",
...
export function MarqueeComponent() {
    ...
    return (
        <div className="relative w-full bg-[#030619] py-16 overflow-hidden">
            <div className="container mx-auto px-4 text-center">
                <h2 className="text-3xl md:text-4xl font-bold mb-12 text-white heading">
                    What Our Users Say
                </h2>
                ...
                <div className="relative w-full">
                    ...
                    <Marquee
                        reverse
                        pauseOnHover
                        className="[--duration:30s] [--gap:1rem] mt-4"
                    >
